...
TcpSocketState::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TcpSocketState")
    ...
    .AddAttribute ("MaxPacingRate", "Set Max Pacing Rate",
                   ...
                   MakeDataRateChecker ())
    .AddAttribute ("Weight", "Set Weight",
                   DoubleValue (0.0),
                   MakeDoubleAccessor (&TcpSocketState::m_weight),
    ...
    .AddTraceSource ("RawRTT",
                     ...
                     MakeTraceSourceAccessor (&TcpSocketState::m_rawRtt),
                     "ns3::TracedValueCallback::Time")
  ;
  return tid;
}
...
TcpSocketState::TcpSocketState (const TcpSocketState &other)
  : Object (other),
    ...
    m_preciseCWnd (other.m_preciseCWnd),
