...
public:
  ...
  double                 m_preciseCWnd      {0}; //!< The precise cwnd computed by floating point operations
  ...
  TracedValue<Time>      m_rawRtt  {Seconds (0.0)};  //!< Raw RTT sample collected

  // Self-defined variables for experiments
  double                 m_weight            {0.0}; //!< Weight of flow
  uint                   m_tenantId           {0}; //!< Tenant Id of flow
