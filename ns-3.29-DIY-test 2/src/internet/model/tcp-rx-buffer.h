...
public:
  ...
  /**
   * \brief set the default value of max buffer size
   */
  static void SetDefaultMaxBufferSize (uint32_t);
  /**
   * \brief Constructor
...
private:
  ...
  static uint32_t m_defaultMaxBuffer;         //!< Default value of the m_maxBuffer
};
