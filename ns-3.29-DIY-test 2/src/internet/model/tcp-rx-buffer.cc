...
uint32_t TcpRxBuffer::m_defaultMaxBuffer = 32768;

void
TcpRxBuffer::SetDefaultMaxBufferSize (uint32_t arg)
{
  m_defaultMaxBuffer = arg;
}
...
TcpRxBuffer::TcpRxBuffer (uint32_t n)
  : m_nextRxSeq (n), m_gotFin (false), m_size (0), m_maxBuffer (m_defaultMaxBuffer), m_availBytes (0)
{
